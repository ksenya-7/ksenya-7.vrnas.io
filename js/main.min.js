...
/* harmony import */ var _modules_parallax_init_parallax__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/parallax/init-parallax */ "./js/modules/parallax/init-parallax.js");
/* harmony import */ var _modules_animation_init_animation__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/animation/init-animation */ "./js/modules/animation/init-animation.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_parallax_init_parallax__WEBPACK_IMPORTED_MODULE_7__["initParallax"])();
    Object(_modules_animation_init_animation__WEBPACK_IMPORTED_MODULE_8__["initAnimation"])();
  });
});
  ...
  if (items.length) {
    items.forEach(function (item) {
      ...
      var onCardMove = function onCardMove(evt) {
        var parallaxLeftOffset = item.getBoundingClientRect().left;
        var parallaxTopOffset = item.getBoundingClientRect().top;
        var coordX = evt.clientX - parallaxLeftOffset - 0.5 * item.offsetWidth;
        var coordY = evt.clientY - parallaxTopOffset - 0.5 * item.offsetHeight;
      ...
      var onCardOut = function onCardOut() {
